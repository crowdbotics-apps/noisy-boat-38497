"""
Django settings for noisy_boat_38497 project.
...
ROOT_URLCONF = 'noisy_boat_38497.urls'
...
WSGI_APPLICATION = 'noisy_boat_38497.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_boat_38497 API",
    "DESCRIPTION": "API documentation for noisy_boat_38497 App",
    "VERSION": "v1",
}
